...
function App() {
    ...
    return (
      <>  
          ...
          <h4 className="specialmessage">SPECIAL MESSAGE FROM MWS: Strong Santa Ana wind event with critical fire weather conditions likely early next week. For more information, please see the fire weather watches/warnings for your specific area. </h4>
